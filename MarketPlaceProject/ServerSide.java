                ...
                switch (option) {
                    ...
                    case "3 - Create":
                        ...
                        if (storeChoice3.equals("1. N/A") ||
                            ...
                            if (storeChoice3.equals("1. N/A")) {
                                String createResult = MarketplaceServer.createStoreNA(storeName);
                                //4cre - Create Store Result
                                pw.write(createResult + "\n");  pw.flush();
                            }
                            if ("Create new store".equals(storeChoice3.substring(storeChoice3.length() - 16))) {
                                String createResult = MarketplaceServer.createStore(storeName);
                                //4cre - Create Store Result
                                pw.write(createResult + "\n");  pw.flush();
                            }
                        } else {
                            ...
                            while (true) {
                                ...
                                boolean checkName = MarketplaceServer.checkProductName(storeChoice3, productName);
                                if (checkName) {
                                    ...
                                    createProductResult = MarketplaceServer.createProduct(storeChoice3, productName,
                                            prodDesc, prodQuant, prodPrice, prodLimit);
                                    break;
                                } else {
                                    //6cre - checkName exists
                                    pw.write("false\n");
